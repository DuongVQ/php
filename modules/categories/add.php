...
<div class="container">
    <div class="row" style="margin: 50px auto;">
        <h2 class="text-center text-uppercase">Thêm nhóm hàng</h2>
        <?php 
            if(!empty($smg)) {
                getSmg($smg, $smg_type);
            }
        ...
        <form action="" method="post">
            <div class="form-group mg-form">
                ...
                <input type="name" class="form-control" id="name" name="name" placeholder="Nhập tên hàng" value="<?php echo old('name', $old); ?>">
