...
<body>
    <header class="p-3 border-bottom position-fixed w-100 z-1 bg-white shadow-sm" style="z-index: 10;">
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="#" class="nav-link px-2 link-body-emphasis text-uppercase">Home</a></li>
                    <li><a href="#" class="nav-link px-2 link-body-emphasis text-uppercase">Products</a></li>
                    <li><a href="#" class="nav-link px-2 link-body-emphasis text-uppercase">Inventory</a></li>
                    <li><a href="?module=home&action=about-us" class="nav-link px-2 link-body-emphasis text-uppercase">About us</a></li>
                </ul>
